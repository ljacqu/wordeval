...
import ch.jalu.wordeval.dictionary.hunspell.sanitizer.ItSanitizer;
import ch.jalu.wordeval.dictionary.hunspell.sanitizer.FrSanitizer;
import ch.jalu.wordeval.dictionary.hunspell.sanitizer.HuSanitizer;
...
final class DictionaryData {
  ...
  public static final Dictionary AF = hunspellDictionary("af").sanitizer(".", "µ", "Ð", "ø").build();
  ...
  public static final Dictionary DE_DE = hunspellDictionary("de-de").sanitizer("#", "°").build();
  ...
  public static final Dictionary EU = hunspellDictionary("eu").sanitizer(".", "+", "_").build();
  public static final Dictionary FR = hunspellDictionary("fr").sanitizer(new FrSanitizer()).build();
  public static final Dictionary HU = hunspellDictionary("hu").sanitizer(new HuSanitizer()).build();
  public static final Dictionary IT = hunspellDictionary("it").sanitizer(new ItSanitizer()).build();
  ...
  public static final Dictionary RU = hunspellDictionary("ru").sanitizer(".").build();
